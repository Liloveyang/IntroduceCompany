		...
		if ($('.isotope-container').length>0 || $('.masonry-grid').length>0 || $('.masonry-grid-fitrows').length>0) {
			...
			$(window).load(function() {
				...
				var $container = $('.isotope-container').isotope({
					...
					layoutMode: 'masonry',
					transitionDuration: 'http://www.flaginfo.com.cn/js/0.6s',
					filter: "*"
				});
		...
		if($("#contact-form").length>0) {
			$("#contact-form").validate({
				submitHandler: function(form) {
					...
					$.ajax({
						type: "POST",
						url: "http://www.flaginfo.com.cn/js/php/contact-form.php",
						data: {
				...
				messages: {
					...
					email: {
						...
						email: "http://www.flaginfo.com.cn/js/Please enter a valid email address e.g. name@domain.com"
					},
					subject: {
